...
const skillDescriptionsPt = {
    python: `<p>Com 4 anos de experiência, eu mergulho fundo no <b>Python</b> para explorar duas áreas empolgantes: <b>desenvolvimento de software</b> e <b>ciência de dados</b>.</p>
            <p>No desenvolvimento de software, uso pacotes como <i>FastAPI</i>, <i>SQLAlchemy</i>, <i>Pydantic</i>, <i>PyJWT</i>, e outros pacotes, além de também utilizar o <i>Pytest</i> e <i>unittest</i> para construir aplicações robustas, seguras e eficientes.</p>
    ...
    java: `<p>Com 4 anos de experiência, o <b>Java</b> tem sido uma peça fundamental no meu desenvolvimento como programador.</p>
            ...
            `,
    csharp: `<p>Com 1 ano de experiência, o <b>C#</b> tem sido uma adição valiosa ao meu conjunto de habilidades de desenvolvimento.</p>
    ...
    kotlin: `<p>Com 1 ano de experiência, o <b>Kotlin</b> tem se mostrado uma ferramenta essencial em minha jornada de desenvolvimento.</p>
    ...
    sass: `<p>Com 4 anos de experiência, o <b>Sass</b> se tornou uma ferramenta essencial para otimizar meu desenvolvimento <i>CSS</i>.</p>
    ...
    js: `<p>Com 5 anos de experiência, o <b>JavaScript</b> se tornou uma ferramenta fundamental em meu arsenal de desenvolvimento.</p>
    ...
    react: `<p>Com 2 anos de experiência, o <b>ReactJS</b> se tornou uma ferramenta poderosa em meu arsenal de desenvolvimento web.</p>
    ...
    database: `<p>Com 5 anos de experiência na construção, gerenciamento e utilização de <b>bancos de dados SQL</b>, desenvolvi uma forte expertise nessa área.</p>
    ...
    docker: `<p>Com 2 anos de experiência, o <b>Docker</b> tem se tornado uma ferramenta essencial na minha stack de desenvolvimento.</p>
    ...
    cloud: `<p>Com 2 anos de experiência, a <b>nuvem</b> se tornou uma parte fundamental da minha abordagem de desenvolvimento.</p>
    ...
    git: `<p>Com 4 anos de experiência com o <b>Git e GitHub</b>, essas ferramentas se tornaram fundamentais em meus projetos pessoais e acadêmicos.</p>
...
const skillDescriptionsEn = {
    python: `<p>With 4 years of experience, I dive deep into <b>Python</b> to explore two exciting areas: <b>software development</b> and <b>data science</b>.</p>
            <p>In software development, I use packages like <i>FastAPI</i>, <i>SQLAlchemy</i>, <i>Pydantic</i>, <i>PyJWT</i>, and others, also utilizing <i>Pytest</i> and <i>unittest</i> to build robust, secure, and efficient applications.</p>
    ...
    java: `<p>With 4 years of experience, <b>Java</b> has been a fundamental part of my development as a programmer.</p>
    ...
    csharp: `<p>With 1 year of experience, <b>C#</b> has been a valuable addition to my development skill set.</p>
    ...
    kotlin: `<p>With 1 year of experience, <b>Kotlin</b> has proven to be an essential tool in my development journey.</p>
    ...
    sass: `<p>With 4 years of experience, <b>Sass</b> has become an essential tool for optimizing my <i>CSS</i> development.</p>
    ...
    js: `<p>With 5 years of experience, <b>JavaScript</b> has become a fundamental tool in my development arsenal.</p>
    ...
    react: `<p>With 2 year of experience, <b>ReactJS</b> has become a powerful tool in my web development arsenal.</p>
    ...
    database: `<p>With 5 years of experience in building, managing, and utilizing <b>SQL databases</b>, I have developed strong expertise in this area.</p>
    ...
    docker: `<p>With 2 years of experience, <b>Docker</b> has become an essential tool in my development stack.</p>
    ...
    cloud: `<p>With 1 year of experience, <b>cloud computing</b> has become a fundamental part of my development approach.</p>
    ...
    git: `<p>With 4 years of experience with <b>Git and GitHub</b>, these tools have become fundamental in my personal and academic projects.</p>
